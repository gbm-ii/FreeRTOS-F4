...
union bf2_ {
	struct {
		uint8_t p0:2, p1:2, p2:2, p3:2, p4:2, p5:2, p6:2, p7:2,
...
union bf4_ {
	struct {
		uint8_t p0:4, p1:4, p2:4, p3:4, p4:4, p5:4, p6:4, p7:4;
	};
	struct {
		uint8_t p8:4, p9:4, p10:4, p11:4, p12:4, p13:4, p14:4, p15:4;
	};
	uint32_t w;
};
...
union dma_cselr_ {
	struct {
		uint8_t c1s:4, c2s:4, c3s:4, c4s:4, c5s:4, c6s:4, c7s:4;
	};
	uint32_t w;
};
